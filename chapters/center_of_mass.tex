...
\section{Mapping electric field in a Sub-\SI{1}{\degree} \ce{WSe_2} Moiré superlattice}
...
%
The results of this calculation are presented in Figure~\ref{fig:m_mom} in Appendix \ref{appendix:a}. 
%
...
\clearpage
\section{Mapping momentum transfer in a Sub-\SI{2.3}{\degree} \ce{WSe_2} Moiré superlattice}
\label{sec:large_moire}
% Vortices at the vertices
%--------------------------------------------------------------------------------------

In the green-highlighted region of Figure~\ref{fig:moire_overview}\textbf{a}, a double moiré pattern emerges from three layers showing two distinct moiré angles.
%
...
%
The CBED shift analysis are displayed in Appendix \ref{appendix:b}.
