...
The HAADF detector is used since the electrons it collect are almost exclusively incoherently elastically scattered which is proportional to the atomic number Z.
\begin{figure}[h]
    \centering
