\section{Analysis of heterostrain in twisted a $MoSe_2/WSe_2$ heterobilayer structure}% State of the art
%
...
\subsection{Micrometre field-of-view strain analysis}
%
%-------------------------------------------------------
\begin{equation}
